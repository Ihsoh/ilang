...
LEXER_MATCHER(keyword)
	*abandon = 0;
	...
	static struct _Keyword {
		...
		_KEYWORD("call", BE_TOKEN_KEYWORD_CALL),
		...
		_KEYWORD("__va_list", BE_TOKEN_KEYWORD_VA_LIST),
		...
		_KEYWORD("vcall", BE_TOKEN_KEYWORD_VCALL),

		_KEYWORD("add", BE_TOKEN_KEYWORD_ADD),
		_KEYWORD("sub", BE_TOKEN_KEYWORD_SUB),
		_KEYWORD("mul", BE_TOKEN_KEYWORD_MUL),
		_KEYWORD("div", BE_TOKEN_KEYWORD_DIV),
		_KEYWORD("rem", BE_TOKEN_KEYWORD_REM),
		_KEYWORD("mbr", BE_TOKEN_KEYWORD_MBR),
		_KEYWORD("idx", BE_TOKEN_KEYWORD_IDX),
		_KEYWORD("not", BE_TOKEN_KEYWORD_NOT),
		_KEYWORD("neg", BE_TOKEN_KEYWORD_NEG),
		_KEYWORD("bnot", BE_TOKEN_KEYWORD_BNOT),
		_KEYWORD("ref", BE_TOKEN_KEYWORD_REF),
		_KEYWORD("shl", BE_TOKEN_KEYWORD_SHL),
		_KEYWORD("shr", BE_TOKEN_KEYWORD_SHR),

		_KEYWORD("eq", BE_TOKEN_KEYWORD_EQ),
		_KEYWORD("neq", BE_TOKEN_KEYWORD_NEQ),
		_KEYWORD("lt", BE_TOKEN_KEYWORD_LT),
		_KEYWORD("le", BE_TOKEN_KEYWORD_LE),
		_KEYWORD("gt", BE_TOKEN_KEYWORD_GT),
		_KEYWORD("ge", BE_TOKEN_KEYWORD_GE),

		_KEYWORD("band", BE_TOKEN_KEYWORD_BAND),
		...
		_KEYWORD("__va_start", BE_TOKEN_KEYWORD_VA_START),
		_KEYWORD("__va_copy", BE_TOKEN_KEYWORD_VA_COPY),
		_KEYWORD("__va_end", BE_TOKEN_KEYWORD_VA_END),
		_KEYWORD("__va_arg", BE_TOKEN_KEYWORD_VA_ARG),
