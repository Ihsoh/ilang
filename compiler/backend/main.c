...
static void _help(void) {
	...
	"\n"
	"usage: ilcbe <source file> [-arch (32|64)] [-platform (windows|system-v|isystem)] [-incpath <include path>] [-action (compile|printast|preprocess)]\n"
	...
	"  -platform (windows|system-v|isystem)     Specify platform.\n"
